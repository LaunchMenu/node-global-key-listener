 ...
 */
export const WinGlobalKeyLookup: IGlobalKeyLookup = {
  ...
  0x08: { _nameRaw: "VK_BACK"                , name: "BACK"                , standardName: "" },
  0x09: { _nameRaw: "VK_TAB"                 , name: "TAB"                 , standardName: "TAB" },
  0x0C: { _nameRaw: "VK_CLEAR"               , name: "CLEAR"               , standardName: "" },
  ...
  0x1B: { _nameRaw: "VK_ESCAPE"              , name: "ESCAPE"              , standardName: "" },
  ...
  0x20: { _nameRaw: "VK_SPACE"               , name: "SPACE"               , standardName: "" },
  0x21: { _nameRaw: "VK_PRIOR"               , name: "PRIOR"               , standardName: "" },
  0x22: { _nameRaw: "VK_NEXT"                , name: "NEXT"                , standardName: "" },
  0x23: { _nameRaw: "VK_END"                 , name: "END"                 , standardName: "" },
  0x24: { _nameRaw: "VK_HOME"                , name: "HOME"                , standardName: "" },
  ...
  0x2C: { _nameRaw: "VK_SNAPSHOT"            , name: "SNAPSHOT"            , standardName: "" },
  0x2D: { _nameRaw: "VK_INSERT"              , name: "INSERT"              , standardName: "" },
  0x2E: { _nameRaw: "VK_DELETE"              , name: "DELETE"              , standardName: "" },
  0x2F: { _nameRaw: "VK_HELP"                , name: "HELP"                , standardName: "" },
  0x5B: { _nameRaw: "VK_LWIN"                , name: "LWIN"                , standardName: "" },
  0x5C: { _nameRaw: "VK_RWIN"                , name: "RWIN"                , standardName: "" },
  ...
  0x6A: { _nameRaw: "VK_MULTIPLY"            , name: "MULTIPLY"            , standardName: "" },
  0x6B: { _nameRaw: "VK_ADD"                 , name: "ADD"                 , standardName: "" },
  0x6C: { _nameRaw: "VK_SEPARATOR"           , name: "SEPARATOR"           , standardName: "" },
  0x6D: { _nameRaw: "VK_SUBTRACT"            , name: "SUBTRACT"            , standardName: "" },
  0x6E: { _nameRaw: "VK_DECIMAL"             , name: "DECIMAL"             , standardName: "" },
  0x6F: { _nameRaw: "VK_DIVIDE"              , name: "DIVIDE"              , standardName: "" },
  ...
  0xBA: { _nameRaw: "VK_OEM_1"               , name: "OEM_1"               , standardName: "" },
  0xBB: { _nameRaw: "VK_OEM_PLUS"            , name: "OEM_PLUS"            , standardName: "" },
  0xBC: { _nameRaw: "VK_OEM_COMMA"           , name: "OEM_COMMA"           , standardName: "" },
  0xBD: { _nameRaw: "VK_OEM_MINUS"           , name: "OEM_MINUS"           , standardName: "" },
  0xBE: { _nameRaw: "VK_OEM_PERIOD"          , name: "OEM_PERIOD"          , standardName: "" },
  0xBF: { _nameRaw: "VK_OEM_2"               , name: "OEM_2"               , standardName: "" },
  0xC0: { _nameRaw: "VK_OEM_3"               , name: "OEM_3"               , standardName: "" },
  0xDB: { _nameRaw: "VK_OEM_4"               , name: "OEM_4"               , standardName: "" },
  0xDC: { _nameRaw: "VK_OEM_5"               , name: "OEM_5"               , standardName: "" },
  0xDD: { _nameRaw: "VK_OEM_6"               , name: "OEM_6"               , standardName: "" },
  0xDE: { _nameRaw: "VK_OEM_7"               , name: "OEM_7"               , standardName: "" },
  0xDF: { _nameRaw: "VK_OEM_8"               , name: "OEM_8"               , standardName: "" },
  0xE2: { _nameRaw: "VK_OEM_102"             , name: "OEM_102"             , standardName: "" },
